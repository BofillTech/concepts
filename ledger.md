...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 155 | jetty-cape-may | 2026-09-21 | asymmetric-collage | hero,welcome,gallery,rooms,amenities-narrative,location,reviews,cta | single-column-editorial | persistent-bottom-bar | parallax | high-contrast-editorial-serif-with-rule-lines | Bodoni Moda | Outfit | fog-blue+cedar-shingle+dune-sage+sand-cream+faded-coral+ink-charcoal |
