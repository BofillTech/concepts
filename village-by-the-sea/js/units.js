      ...
      '<section class="unit-hero">' +
        '<div class="container unit-hero__grid">' +
          '<div class="unit-hero__copy">' +
            ...
            '<p class="unit-hero__lede">Individually owned and individually decorated &mdash; these are photographs of this exact unit, not a sample of the category.</p>' +
        ...
        '<section class="unit-view">' +
          '<div class="container">' +
            '<div class="section-head">' +
              ...
              '<p class="section-lede">Not a stock shot of the property &mdash; this is what you see standing on the deck of unit ' + u + '.</p>' +
            '</div>' +
            '<div class="view-grid">' +
      ...
      '<section class="unit-book">' +
        '<div class="container unit-book__grid">' +
          '<div>' +
            ...
            '<p class="section-lede">Individual units aren&rsquo;t bookable online &mdash; you reserve a suite type and level. Call the front desk and request unit ' + u + ' by number and we&rsquo;ll do our best to hold it for your dates.</p>' +
            '<p class="unit-hero__actions">' +
              '<a class="btn btn--primary" href="https://hotels.cloudbeds.com/reservation/IoseEY">Check availability</a>' +
